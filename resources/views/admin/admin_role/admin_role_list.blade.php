        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show" style="padding:20px;">
                    <!--主体开始-->
                    <form id="myform" action="{{url('admin/adminRole/getList')}}" method="get">
                    <blockquote class="layui-elem-quote news_search">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                 <input type="text" name="admin_id" value="{{$admin_id or ''}}" placeholder="请输入管理员id" class="layui-input search_input">
                            </div>
                            <div class="layui-input-inline">
                            ...
                            <a href="{{url('admin/adminRole/index')}}" class="layui-btn search_btn" style="background-color:#5FB878">添加链接</a>
                        </div>
                    </blockquote>
                    </form>
                    <div class="layui-form links_list">
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/admin/adminRole/index?id='.$itme->id)}}" ><i class="iconfont icon-edit"></i> 编辑</a>
...
<script>
    ...
    function deleteById(id){
        layer.confirm('确定要删除吗？',{'title':"提示",'icon':0,'closeBtn':0,'shadeClose':true}, function(index){
            $.post("{{url('admin/adminRole/delete')}}",{
                "id":id,
            },function(data){
                if(data.code==1){
                    location.href ="{{url('admin/adminRole/getList')}}";
                }
            },"json")
            layer.close(index);
        });
    ...
    function exportTable()
    {
        ...
        window.open("{{url('admin/adminRole/export')}}?"+param);
        return;
    }
</script>
</body>
