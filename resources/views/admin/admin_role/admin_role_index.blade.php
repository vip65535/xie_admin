        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show" style="padding:20px;">
                    <!--主体开始-->
                        <form class="layui-form" action="{{url("adminRole/add")}}" method="post">
                        <input hidden name="id" value="{{$adminRole->id or ''}}" />
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">管理员id</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="admin_id" value="{{$adminRole->admin_id or ''}}" class="layui-input newsName" lay-verify="required" placeholder="管理员id">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">角色id</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="role_id" value="{{$adminRole->role_id or ''}}" class="layui-input newsName" lay-verify="required" placeholder="角色id">
                                        </div>
                                    </div>
                            <div class="layui-form-item">
                            <div class="layui-input-block">
