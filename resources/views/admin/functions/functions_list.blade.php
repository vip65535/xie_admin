...
<!-- 右侧内容 -->
    <div class="layui-body layui-form">
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <a class="layui-btn layui-btn-sm layui-btn-warm" style="margin-left: 100px;margin-top:5px;" onclick="addtop();">新增顶级菜单</a>
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show" style="padding:20px;">
                    <div class="layui-row layui-col-space10">
                        <div class="layui-col-md3" style="overflow: scroll;max-height:500px;">
                        ...
                        <div class="layui-col-md9">
                            ...
                            <form id="myform" class="layui-form" action="functions/add" method="post">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="radio" name="type" value="1" title="功能节点">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="icon_class" value="" class="layui-input newsName" placeholder="图标">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="href" value="" class="layui-input newsName"  placeholder="链接">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
...
<script>
    ...
    function addForm() {
        ...
        $.post("functions/add",data,function(data){
            if(data.code==1){
                layer.msg(data.m);
                flushTree();
            }
    ...
    function addtop() {
        formDataLoad("myform",{"pid":0,"sort":0,"name":"","icon_class":'',"href":'',"id":''});
    }
