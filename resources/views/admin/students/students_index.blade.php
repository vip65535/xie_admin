            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show" style="padding:20px;">
                    ...
                    @endif
                        ...
                        <input hidden name="id" value="{{$students->id or ''}}" />
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">姓名</label>
                                        <div class="layui-input-block">
                                            <input type="text" style="width:400px;" name="name" value="{{$students->name or ''}}" class="layui-input newsName" lay-verify="required" placeholder="姓名">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">年级</label>
                                        <div class="layui-input-block">
                                            <input type="text" style="width:400px;" name="grade" value="{{$students->grade or ''}}" class="layui-input newsName" lay-verify="required" placeholder="年级">
                                        </div>
                                    </div>
