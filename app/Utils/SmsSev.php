...
require_once(dirname(dirname(dirname(__FILE__))).'/Ext/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php');
...
class SmsSev
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAId44C9CEsKiCH"; // AccessKeyId

        $accessKeySecret = "ID5BQVGVt3gZOdM9Ds8dYNDsRhv8bU"; // AccessKeySecret
